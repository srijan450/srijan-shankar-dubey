      ...
      <section className="pages">
        <div className="row">
          ...
          <div className="left">
            ...
            <p className="text">
              Thank you for visiting! Whether you have a project in mind, a
              question to ask, or just want to connect, I'm here for you. Your
              input is invaluable, so feel free to reach out using the form
              below.
            </p>
            <p className="text">Let's make something great together!</p>
            <form
              method="POST"
